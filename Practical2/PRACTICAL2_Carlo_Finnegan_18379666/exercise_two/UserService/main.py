...
def borrow_book():
    ...
    print(data)
    required_fields = {"studentid":str, "bookid":int, "date_returned":str}

    #need to change from issubset as didnt allow dictionary also json only passes 
    #data of type string so cant check for datetype unless parse it here
    ...
    return jsonify({"message": "Borrow request succesfully posted", "request":data}), 201
